...
4. يرسل الموكب الذي اختاره العميل كمرجع A، وأصل الطباعة غير القابل للتعديل كمرجع B إلى `gemini-3.1-flash-image` لإنشاء المعاينة الواقعية.
5. يسمح Gemini فقط بالتحويل الهندسي والتفاعل البصري مع طيات القماش؛ لا يُسمح بإعادة رسم النص أو الألوان أو عناصر التصميم.
6. لا يستطيع العميل تشغيل هذا الخط بإرسال `pipeline` يدويًا؛ الخادم يفعّله حصريًا لطلبات نفس النطاق القادمة من `DEV V3`.
