import { getWashaDtfGenAiClient, WASHA_DTF_MODEL, extractGeneratedImageDataUrl } from "@/lib/washa-dtf-studio";
...
export class AiStudioService {
     ...
     */
    static async generateMockup(prompt: string, referenceImage?: { base64: string; mimeType: string } | null) {
